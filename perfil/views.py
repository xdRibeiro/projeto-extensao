...
def home(request):
    ...
    return render(request, 'home.html', {'contas': contas, 
                                        'total_contas': total_contas, 'total_entradas': total_entradas, 'total_saidas': total_saidas, 
...
def deletar_banco(request, id):
    ...
    conta.delete()
    messages.add_message(request, constants.SUCCESS, 'Conta deletada com êxito.')
    return redirect('/perfil/gerenciar/')
